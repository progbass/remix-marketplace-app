          ...
          <div className="flex flex-1 flex-col space-y-1 p-4">
            <div>
              ...
              <Link 
                ...
                >
                  {trimWithEllipsis(product?.brand?.brand, 26) || trimWithEllipsis(product?.user, 26)|| ''}
              </Link>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center align-middle">
                {hasDiscount && (
                  <span 
                    className="text-sm font-medium line-through text-gray-500 mr-1"
                  >{formatPrice(product.pre_price)}</span>
                )}
